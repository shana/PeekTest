...
namespace PeekTest
{
    ...
    /// other things.
    /// </summary>
    internal class CommentPeekPeekableItem : IPeekableItem
    {
        internal ITextBuffer TextBuffer { get; }

        internal CommentPeekPeekableItem(ITextBuffer textBuffer)
        {
            if (textBuffer == null)
            {
        ...
        public IEnumerable<IPeekRelationship> Relationships
        {
            get
            {
                yield return CommentPeek.Instance.Value;
            }
        }
        ...
        {
            private readonly CommentPeekPeekableItem item;

            public ResultSource(CommentPeekPeekableItem item)
            {
                this.item = item;
            }
